...
var changeCase = function changeCase(val) {
...
//   // return (result.innerHTML = `<p>It was a draw! You both chose ${changeCase(
//   //   user
//   // )}</p>`);
//   // if (
...
//   //   return (result.innerHTML = `<p>${changeCase(user)} beats ${changeCase(
//   //     computer
//   //   )}. You win!</p>`);
//   // }
//   // cScore++;
//   // computerScore.innerHTML = cScore;
//   // return (result.innerHTML = `<p>${changeCase(computer)} beats ${changeCase(
//   //   user
//   // )}. You lose!</p>`);
// };
// module.exports = { game, play, getComputerChoice, changeCase };
...
var getOutput = function getOutput(val) {
  if (val === uScore) {
    userScore.innerHTML = uScore;
    return result.innerHTML = "<p>User wins!</p>";
  }

  if (val === cScore) {
    computerScore.innerHTML = cScore;
    return result.innerHTML = "<p>Computer wins!</p>";
  }
